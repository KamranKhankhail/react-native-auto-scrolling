    ...
    var AutoScrolling = /** @class */ (function (_super) {
        ...
        AutoScrolling.prototype.render = function () {
            ...
            return (React.createElement(reactNative.View, { style: style },
                React.createElement(reactNative.ScrollView, { horizontal: true, showsHorizontalScrollIndicator: false, bounces: false, scrollEnabled: false, onLayout: this.measureContainerView },
